...
1. Use the GitHub MCP server to fetch the pull request diff:
   - pull_request_read
...
5. Create a pending review and submit all comments via GitHub MCP:
   ...
   - add_comment_to_pending_review (once per comment)
